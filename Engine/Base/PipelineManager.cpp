...
PipelineManager::PipelineManager() {
	...
	pipelineObj_["Particle"]->CreatePipeline(2, PipelineObj::NONE, D3D12_PRIMITIVE_TOPOLOGY_TYPE_POINT);
	...
	pipelineObj_["Particle2D"]->CreatePipeline(2, PipelineObj::NONE, D3D12_PRIMITIVE_TOPOLOGY_TYPE_POINT);
